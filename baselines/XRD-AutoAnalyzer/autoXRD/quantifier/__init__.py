...
def main(spectra_directory, spectrum_fname, predicted_phases, scale_factors, min_angle=10.0, max_angle=80.0, wavelength='CuKa', rietveld=True, refined_phases_dir=None, reference_dir='References'):
        ...
        if rietveld:
            ...
            result = do_refinement_no_saving(
                ...
                phase_paths=[
                    Path('%s/%s' % (reference_dir, cmpd)) for cmpd in predicted_phases
                ],
            ...
            analyzer = QuantAnalysis(spectra_directory, spectrum_fname, predicted_phases, scale_factors, min_angle, max_angle, wavelength, reference_dir=reference_dir)
            ...
            for (cmpd, I_set) in zip(predicted_phases, intensity_sets):
                ...
                I_expec.append(get_max_intensity(cmpd, min_angle, max_angle, ref_dir=reference_dir))
                V.append(get_volume(cmpd, ref_dir=reference_dir))
                dens.append(get_density(cmpd, ref_dir=reference_dir))
