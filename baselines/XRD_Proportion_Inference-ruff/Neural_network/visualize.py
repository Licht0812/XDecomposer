...
if __name__ == '__main__':
    ...
    default_model_path = os.path.join(script_dir, '..', 'best_separation_model_fold_0.pth')
    default_plots_dir = os.path.join(script_dir, '..', 'plots')
    
    parser.add_argument('--load_path', default=default_model_path, type=str)
    parser.add_argument('--db_path', default='/data/group/project1/Crystal/UniqRruffCrystal.db', type=str)
    parser.add_argument('--entries_dict', default='/data/home/zdhs0019/Projects/xrd_baselines/XQueryer-ruff/src/entries_dict.json', type=str)
    ...
    _, _, test_loader = get_dataloaders(args.db_path, config, batch_size=args.batch_size, num_workers=args.num_workers, num_folds=args.num_folds, fold=args.fold)
