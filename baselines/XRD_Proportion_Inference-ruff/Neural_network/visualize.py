...
if __name__ == '__main__':
    ...
    parser.add_argument('--db_path', default='data/UniqRruffCrystal.db', type=str)
    parser.add_argument('--entries_dict', default='../XQueryer-ruff/src/entries_dict.json', type=str)
